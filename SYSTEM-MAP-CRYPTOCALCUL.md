...
**Revision 2026-09-19-a.** A methodology revision: the analytical engine cuts the stop of an
own-trend pullback from the 24-hour extreme its zone rests on, through `invalidationInfo`'s own
floor, instead of from the 30-day extreme whose capped distance production itself declares no
stop (`ANALYST-INSTRUCTIONS.md` `2026-09-19-a`), and §10 records the measurement that geometry is
owed. `2026-09-18-a` gave inv. 30 its analytical-engine clause and restated §10's direction row;
**its revision anchor was left at `2026-09-17-a` in the table below, where every TZ gate would
have met a revision string this file no longer carried** — the anchor now matches this line again.
...
|---|---|
| revision | `**Revision 2026-09-19-a.**` |
