...
**Revision 2026-09-18-a.** A methodology revision: inv. 30 gains the analytical engine's clause —
the engine takes a coin's side from the coin's own regime at the frozen price and prints the
market word as a risk tier (`ANALYST-INSTRUCTIONS.md` `2026-09-18-a`) — and §10's direction row
now states the measure it names. **No production file, bench or workflow moves**, so every row
of the file table below stands. The code baseline is revision `2026-09-17-a`, one branch TZ,
merged:
...
|---|---|
| revision | `**Revision 2026-09-17-a.**` |
