...
**Revision 2026-09-22-b.** A dispatch reading and one specification; no file moves, so every row
of the file table below stands. Run #25 of `backtest_bench.yml` (commit `3758dc6`, 21.09.2026,
...
as a failure. **TZ-51 is specified to read the archive AT production's instant wherever the
